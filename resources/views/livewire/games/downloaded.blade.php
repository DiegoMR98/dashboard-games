<div class="mr-2 pb-4 xl:pb-0">
    <div class="flex justify-between items-end md:mt-[-12px]">
    ...
    <div class="flex flex-col md:flex-row gap-2 justify-between text-white bg-[#BA3C3D] rounded-4xl h-min-[300px] md:h-[120px] mt-4 px-4 py-6">
        ...
        <div class="flex justify-center gap-6 items-center ">
            ...
            <div class="flex flex-col gap-3">
                <h1 class="font-semibold text-md lg:text-xl">FIFA 24</h1>
                <div class="bg-[#361619] px-3 py-1 rounded-xl">
                    <h1 class="text-[10px] lg:text-xl">Sports Simulator</h1>
                </div>

            </div>
        </div>
        <div class="flex flex-col md:flex-row gap-10 items-center justify-center md:justify-normal">
            <div class="flex flex-col items-end">
                <h1 class="text-md lg:text-lg">1 hour 23 min.</h1>
                <h1 class="text-sm lg:text-md opacity-50">256Mb of 1.23Gb</h1>
            </div>
