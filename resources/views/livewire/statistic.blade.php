    ...
    <div class="flex flex-col items-center h-[545px] justify-between bg-[#361619] rounded-4xl mt-3">
        ...
        <div class="flex justify-around mb-6 w-full text-white px-10">
            ...
            <div class="flex flex-col gap-2 items-center">
                <div class="flex justify-center items-center bg-[#C4383D] size-[4vw] rounded-full"><ion-icon name="american-football" class="text-4xl"></ion-icon></div>
                <div><h1>2,340h</h1></div>
            </div>
            <div class="flex flex-col gap-2 items-center">
                <div class="flex justify-center items-center bg-[#F6F7CF] size-[4vw] rounded-full"><ion-icon name="shield" class="text-4xl text-black"></ion-icon></div>
                <div><h1>5,420h</h1></div>
            </div>
            <div class="flex flex-col gap-2 items-center">
                <div class="flex justify-center items-center bg-[#7963CC] size-[4vw] rounded-full"><ion-icon name="skull" class="text-4xl"></ion-icon></div>
